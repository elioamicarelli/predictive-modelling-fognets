...
For this reason, I have written a set of functions to work sequentially on several common tasks such as model training, imputation and exploration of models' performances without polluting the process with data from the future. Unfortunately, it turned out that not all the participants adopted this precaution thus some of them gained a significant advantage on their final score.
